...
export default function CalculatorPage() {
  ...
  return (
    <Box sx={{ minHeight: "100vh", bgcolor: COLORS.background, py: 4, pb: 10 }}>
      <CssBaseline />
      ...
      <Container maxWidth="lg">
        <motion.div variants={containerVariants} initial="hidden" animate="show">
          ...
          <motion.div variants={itemVariants}>
            <Box display="flex" alignItems="center" justifyContent="space-between" mb={4}>
              <Box display="flex" alignItems="center" gap={2}>
                <IconButton onClick={() => { playTone("click"); navigate("/dashboard"); }} sx={{ bgcolor: "white", boxShadow: "0 2px 10px rgba(0,0,0,0.05)" }}>
                  <ArrowBack />
                </IconButton>
              ...
              <Button 
                ...
                onClick={resetAll}
                sx={{ fontWeight: "bold", borderRadius: 3, textTransform: "none" }}
              >
                Reset
              </Button>
            </Box>
          ...
          <motion.div variants={itemVariants}>
            <Paper elevation={0} sx={{ p: 3, mb: 4, borderRadius: 4, bgcolor: COLORS.primary, color: "white", display: "flex", justifyContent: "space-between", alignItems: "center", boxShadow: "0 10px 25px rgba(211, 47, 47, 0.2)" }}>
              <Box>
                <Typography variant="body2" fontWeight="bold" sx={{ opacity: 0.9 }}>Estimasi Total Pendapatan</Typography>
                <Typography variant="h4" fontWeight="900">Rp {totalPendapatan.toLocaleString()}</Typography>
              </Box>
              <Calculate sx={{ fontSize: 50, opacity: 0.2 }} />
            </Paper>
          </motion.div>
                ...
                <Card elevation={0} sx={{ p: 3, borderRadius: 4, bgcolor: "white", height: "100%", border: "1px solid #eee", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
                  ...
                  <Box sx={{ bgcolor: "#f9f9f9", p: 2, borderRadius: 3, my: 1.5 }}>
                    ...
                    <Box display="flex" justifyContent="center" alignItems="center" gap={2}>
                      ...
                      <Typography variant="h4" fontWeight="900" sx={{ minWidth: 50, textAlign: "center" }}>{counts["tako20-tunai"]}</Typography>
                  ...
                  <Box sx={{ bgcolor: "#f9f9f9", p: 2, borderRadius: 3 }}>
                    ...
                    <Box display="flex" justifyContent="center" alignItems="center" gap={2}>
                      ...
                      <Typography variant="h4" fontWeight="900" sx={{ minWidth: 50, textAlign: "center" }}>{counts["tako20-qris"]}</Typography>
                ...
                <Card elevation={0} sx={{ p: 3, borderRadius: 4, bgcolor: "white", height: "100%", border: "1px solid #eee", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
                  ...
                  <Box sx={{ bgcolor: "#f9f9f9", p: 2, borderRadius: 3, my: 1.5 }}>
                    ...
                    <Box display="flex" justifyContent="center" alignItems="center" gap={2}>
                      ...
                      <Typography variant="h4" fontWeight="900" sx={{ minWidth: 50, textAlign: "center" }}>{counts["tako15-tunai"]}</Typography>
                  ...
                  <Box sx={{ bgcolor: "#f9f9f9", p: 2, borderRadius: 3 }}>
                    ...
                    <Box display="flex" justifyContent="center" alignItems="center" gap={2}>
                      ...
                      <Typography variant="h4" fontWeight="900" sx={{ minWidth: 50, textAlign: "center" }}>{counts["tako15-qris"]}</Typography>
                ...
                <Card elevation={0} sx={{ p: 3, borderRadius: 4, bgcolor: "white", height: "100%", border: "1px solid #eee", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
                  ...
                  <Box sx={{ bgcolor: "#f9f9f9", p: 2, borderRadius: 3, my: 1.5 }}>
                    ...
                    <Box display="flex" justifyContent="center" alignItems="center" gap={2}>
                      ...
                      <Typography variant="h4" fontWeight="900" sx={{ minWidth: 50, textAlign: "center" }}>{counts["air-tunai"]}</Typography>
                  ...
                  <Box sx={{ bgcolor: "#f9f9f9", p: 2, borderRadius: 3 }}>
                    ...
                    <Box display="flex" justifyContent="center" alignItems="center" gap={2}>
                      ...
                      <Typography variant="h4" fontWeight="900" sx={{ minWidth: 50, textAlign: "center" }}>{counts["air-qris"]}</Typography>
